...
SELECT
'BDI', '벡 우울척도', '질문지는 21개의 질문으로 구성되어 있습니다. 다음 문장들을 잘 읽고 오늘을 포함하여, 지난 한 주 동안 당신이 느낀 것을 가장 잘 묘사하는 문장을 선택해 주십시오. 당신이 선택한 문장의 번호에 ✔ 표 하여 주십시오. 만일 여러 문장이 동일하게 당신의 상태를 잘 묘사한다면, 그 중 가장 높은 번호에 표시해 주십시오. 한 항목도 빠짐없이 모든 항목에 답하되, 문항마다 반드시 하나의 번호에만 표시해 주십시오.', '{
  "questions": [
    {
      "id": 1,
      "text": "슬픔",
      ...
      "options": [
        ...
        {"id": 2, "text": "나는 슬픔을 느끼고 있다.", "score": 1},
        {"id": 3, "text": "나는 언제나 슬프고 기운을 낼 수가 없다.", "score": 2},
    ...
    },
    {
      ...
      "type": "MULTIPLE_CHOICE",
      "options": [
        {"id": 1, "text": "나는 미래에 대해 특히 의기소침하지 않다.", "score": 0},
    ...
    },
    {
      ...
      "options": [
        ...
        {"id": 2, "text": "나는 전에 하던 식으로 만사를 즐기지 못한다.", "score": 1},
    ...
    },
    {
      ...
      "type": "MULTIPLE_CHOICE",
      "options": [
        {"id": 1, "text": "나는 처벌받고 있다는 느낌을 갖고 있지 않다.", "score": 0},
    ...
    },
    {
      ...
      "options": [
        ...
        {"id": 3, "text": "나는 나 자신에 대하 아주 실망한다.", "score": 2},
    ...
    },
    {
      ...
      "options": [
        ...
        {"id": 2, "text": "나는 나의 약점이나 실수 때문에 언제나 나 자신을 책망한다.", "score": 1},
        {"id": 3, "text": "나는 나의 과오들 때문에 언제나 나 자신을 책망한다.", "score": 2},
        {"id": 4, "text": "나는 발생하는 모든 나뿐 일 때문에 나 자신을 책망한다.", "score": 3}
      ]
    },
    {
      "id": 9,
    ...
    },
    {
      ...
      "options": [
        ...
        {"id": 4, "text": "나는 내가 추해 보인다고 믿는다.", "score": 3}
      ]
    },
    {
      "id": 15,
      ...
      "options": [
        ...
        {"id": 3, "text": "나는 어떤 일이든 하려면 나 자신을 말할 수 없이 밀어 부쳐야만 할 수 있다.", "score": 2},
