...
SELECT
'PDSS', '공황장애 평가척도', '*공황발작의 정의 : 공황발작이란 갑자기 시작해서 급격하게 심해지는 공포나 불안 증상이며 대개는 10분 내에 최고조에 달합니다. 이러한 느낌은 가슴이 두근거리는 것, 숨이 가빠지는 것, 질식감, 어지러움, 땀이 나거나 떨림 등의 불쾌한 신체 감각들과 관련이 있습니다. 때로는 자제력을 잃거나 심장마비가 오거나 죽지는 않을까 하는 파국적인 사고들이 나타나기도 합니다. 완전한 공황삽화는 적어도 4개 이상의 증상을 포함해야하며 제한된 증상삽화는 완전 공황삽화와 유사하지만 증상이 4개 미만인 것을 말합니다. 이러한 정의를 참고하여 대답해 주십시오.', '#E0E7FF', '#6366F1', '{
  "questions": [
    {
      "id": 1,
